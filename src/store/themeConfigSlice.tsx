...
export const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        toggleLocale(state, { payload }) {
            ...
            // Validar si el idioma existe en la lista de idiomas
            const isValidLanguage = state.languageList.some(lang => lang.code === payload);
            if (!isValidLanguage) {
                console.error(`Invalid language code: ${payload}`);
                return;
            }
